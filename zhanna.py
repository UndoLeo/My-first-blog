...
🌑 Предупреждение об Импостере:  
Если вы услышите шёпот:  
> «Ты хочешь спать...»👏 *[два хлопка]*  
...
Если за это время никто не спасёт вас, крикнув:
🌞 "ПРОСНИСЬ!"— вы выбываете из игры.

😵 Если вас не успели разбудить...
Жмите в этом боте на кнопку:  
> «Меня убили... 💀»

---  

Квест пройден, если минимум 5 игроков остались "живы" ❤️‍🩹

Каждые 2 часа вы можете общим голосованием решить, кто импостер и вывести его из игры, но ваши задания на этом не прервутся ‼️

⚔️ Судьба мира — в ваших руках. Кто победит: мудрость или предательство?
